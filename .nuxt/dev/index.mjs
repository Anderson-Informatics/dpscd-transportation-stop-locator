...
import { createHooks } from 'file:///home/anderoy/school-finder/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/anderoy/school-finder/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/anderoy/school-finder/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/anderoy/school-finder/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/anderoy/school-finder/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/anderoy/school-finder/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/anderoy/school-finder/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/anderoy/school-finder/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/anderoy/school-finder/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/anderoy/school-finder/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/anderoy/school-finder/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/anderoy/school-finder/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/anderoy/school-finder/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/anderoy/school-finder/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///home/anderoy/school-finder/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///home/anderoy/school-finder/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/anderoy/school-finder/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///home/anderoy/school-finder/node_modules/unctx/dist/index.mjs';
...
import { renderToString } from 'file:///home/anderoy/school-finder/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/anderoy/school-finder/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///home/anderoy/school-finder/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///home/anderoy/school-finder/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/anderoy/school-finder/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/anderoy/school-finder/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/anderoy/school-finder","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/anderoy/school-finder/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/anderoy/school-finder/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/anderoy/school-finder/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/anderoy/school-finder/.data/kv"}));
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"DPSCD School Finder"};
...
const rootDir = "/home/anderoy/school-finder";
...
const _OLN19m = eventHandler((event) => {
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_SDyn47, lazy: true, middleware: false, method: undefined }
];
...
const geocode_get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const matches = ((_a = data == null ? void 0 : data.result) == null ? void 0 : _a.addressMatches) || [];
    if (matches.length) {
