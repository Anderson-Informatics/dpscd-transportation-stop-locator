...
import { computed, defineComponent, h, inject, markRaw, nextTick, onBeforeUnmount, onMounted, onUnmounted, provide, reactive, ref, render, watch } from "vue";
...
var qe = async (e) => {
	const o = await Promise.all([
		import("/home/anderoy/school-finder/node_modules/leaflet/dist/images/marker-icon-2x.png"),
		import("/home/anderoy/school-finder/node_modules/leaflet/dist/images/marker-icon.png"),
		import("/home/anderoy/school-finder/node_modules/leaflet/dist/images/marker-shadow.png")
	]);
...
var Kt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	WINDOW_OR_GLOBAL: b,
	assertInject: m,
...
var h$1 = Symbol("useGlobalLeaflet");
var M = Symbol("addLayer");
var ee = Symbol("removeLayer");
var H = Symbol("registerControl");
var me = Symbol("registerLayerControl");
var ve = Symbol("canSetParentHtml");
...
var bt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	componentProps: W,
	setupComponent: J
}, Symbol.toStringTag, { value: "Module" }));
...
var G = (e, o) => {
	if (e && o.default) return h("div", { style: { display: "none" } }, o.default());
};
var ft = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	layerProps: D,
	render: G,
	setupLayer: q
...
var Xt = defineComponent({
	...
	props: Pe,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { options: l, methods: a } = Qe(e, t, o);
		return onMounted(async () => {
			const { circle: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var Yt = defineComponent({
	...
	props: re,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { options: l, methods: a } = je(e, t, o);
		return onMounted(async () => {
			const { circleMarker: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
			t.value = markRaw(i(e.latLng, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
...
var Vt = defineComponent({
	...
	setup(e, o) {
		const t = ref(), n = ref(), s = inject(h$1), r = m(H), { options: l, methods: a } = K(e, t);
		return onMounted(async () => {
			const { Control: i, DomEvent: u } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js"), d = i.extend({ onAdd() {
				return n.value;
			} });
...
var xt = defineComponent({
	...
	props: Ce,
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(H), { options: r, methods: l } = Ye(e, t);
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var jt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
...
var Rt = defineComponent({
	...
	props: Te,
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(me), { options: r, methods: l } = Ve(e, t);
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var Pt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
...
var eo = defineComponent({
	...
	props: Me,
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(H), { options: r, methods: l } = xe(e, t);
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var to = defineComponent({
	...
	props: Be,
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(H), { options: r, methods: l } = Re(e, t);
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var oo = defineComponent({
	props: we,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { methods: l, options: a } = et(e, t, o);
		return onMounted(async () => {
			const { featureGroup: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var no = defineComponent({
	props: Ie,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { methods: l, options: a } = tt(e, t, o);
		return onMounted(async () => {
			const { geoJSON: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var ro = defineComponent({
	...
	setup(e, o) {
		const t = ref(), n = ref(null), s = ref(!1), r = inject(h$1), l = m(M), { options: a, methods: i } = Ae(e, t, o);
		return onMounted(async () => {
			const { GridLayer: u, DomUtil: d, Util: y } = r ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js"), w = ot(u, d, y, e.childRender);
...
var so = defineComponent({
	...
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(ve), r = m(be), l = m(fe);
		let a, i, u, d, y;
		const w = (N, P, B) => {
		...
		return onMounted(async () => {
			const { DomEvent: N, divIcon: P, icon: B } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var ao = defineComponent({
	...
	props: Ge,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { options: l, methods: a } = nt(e, t, o);
		return onMounted(async () => {
			const { imageOverlay: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var lo = defineComponent({
	props: te,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { methods: l } = se(e, t, o);
		return onMounted(async () => {
			const { layerGroup: a } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var io = defineComponent({
	...
	setup(e, o) {
		...
		onMounted(async () => {
			e.useGlobalLeaflet && (b.L = b.L || await import("./leaflet.js").then((m) => /* @__PURE__ */ __toESM(m.default)));
			const { map: P, CRS: B, Icon: I, latLngBounds: E, latLng: ue, stamp: $ } = e.useGlobalLeaflet ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
			try {
	...
	render({ attrs: e }) {
		return e.style || (e.style = {}), e.style.width || (e.style.width = "100%"), e.style.height || (e.style.height = "100%"), h("div", {
			...e,
			ref: "root"
...
var uo = defineComponent({
	...
	props: ze,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M);
		provide(ve, () => {
			var u;
		...
		return onMounted(async () => {
			const { marker: u, divIcon: d } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var co = defineComponent({
	...
	props: x,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { options: l, methods: a } = $e(e, t, o);
		return onMounted(async () => {
			const { polygon: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var po = defineComponent({
	...
	props: le,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { options: l, methods: a } = Ne(e, t, o);
		return onMounted(async () => {
			const { polyline: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
			t.value = markRaw(i(e.latLngs, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
...
var yo = defineComponent({
	...
	props: lt,
	setup(e, o) {
		const t = ref(), n = ref(null), s = inject(h$1), r = m(ge), l = m(he), { options: a, methods: i } = it(e, t);
		return onMounted(async () => {
			const { popup: u } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var Zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	rectangleProps: Fe,
	setupRectangle: ut
}, Symbol.toStringTag, { value: "Module" }));
var mo = defineComponent({
	...
	props: Fe,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h$1), r = m(M), { options: l, methods: a } = ut(e, t, o);
		return onMounted(async () => {
			const { rectangle: i, latLngBounds: u } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js"), d = e.bounds ? u(e.bounds) : u(e.latLngs || []);
...
var vo = defineComponent({
	props: ie,
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(M), { options: r, methods: l } = Ze(e, t, o);
		return onMounted(async () => {
			const { tileLayer: a } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var bo = defineComponent({
	...
	props: ct,
	setup(e, o) {
		const t = ref(), n = ref(null), s = inject(h$1), r = m(Le), { options: l, methods: a } = dt(e, t);
		return onMounted(async () => {
			const { tooltip: i } = s ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
...
var fo = defineComponent({
	props: Ee,
	setup(e, o) {
		const t = ref(), n = inject(h$1), s = m(M), { options: r, methods: l } = pt(e, t, o);
		return onMounted(async () => {
			const { tileLayer: a } = n ? b.L : await import("./leaflet-src.esm-Kby6BBm4.js");
